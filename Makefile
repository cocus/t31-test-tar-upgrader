...
build_pan/autoupdate-full.bin:
	@echo " [THINGINO-Fw]    $@"
	@wget -q https://github.com/themactep/thingino-firmware/releases/latest/download/thingino-personal_campan_t31x_gc2053_atbm6031.bin -O $@ 2>&1 > /dev/null

build_cam2/autoupdate-full.bin:
	@echo " [THINGINO-Fw]    $@"
	@wget -q https://github.com/themactep/thingino-firmware/releases/latest/download/thingino-personal_cam2_t31x_gc2053_atbm6031.bin -O $@ 2>&1 > /dev/null
